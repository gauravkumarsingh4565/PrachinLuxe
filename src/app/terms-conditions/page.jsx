...
export const metadata = {
  title: 'Terms and Conditions | Prachin Luxy',
  description: 'Terms and Conditions for using Prachin Luxy website and services.',
};
  ...
  return (
    <div className="min-h-screen bg-sand-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 shadow-royal rounded-sm border border-gold-200">
        ...
        {/* Content */}
        <div className="font-outfit text-[#34495e] space-y-6 leading-relaxed">
          <ul className="list-disc list-outside ml-5 space-y-4">
            ...
            <li>
              This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://prachinluxy.com application.
            </li>
            <li>
              The Platform is owned by MALAYAA ART AND CRAFTS, a company incorporated under the Companies Act, 1956 with its registered office Gadadhar Nivas, Hatijhari, Baisinga, Mayurbhanj, Odisha, 757052. (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').
            </li>
            <li>
            ...
            <li>
              ...
              <ul className="list-[circle] list-outside ml-6 mt-3 space-y-3">
                <li>
