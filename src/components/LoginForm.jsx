  ...
  return (
    <div className="w-full max-w-[420px] flex flex-col justify-center font-cormorant animate-fade-in-up">
      ...
      <button
        ...
        disabled={isLoading}
        className="group relative w-full flex items-center justify-center gap-4 py-4 px-6 bg-gradient-to-r from-white via-sand-50/80 to-white hover:from-sand-50 hover:to-gold-50/30 border border-gold-400/40 hover:border-gold-500 rounded-2xl shadow-sm hover:shadow-gold-lg transition-all duration-300 transform hover:-translate-y-0.5 cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed overflow-hidden"
      >
        {/* Shimmer Effect */}
        <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-1000 bg-gradient-to-r from-transparent via-gold-300/15 to-transparent" />
        ...
        <div className="flex flex-col items-start relative z-10">
          <span className="font-cinzel text-xs font-extrabold tracking-[0.18em] text-royal-blue-950 uppercase leading-none">
        ...
        {!isLoading && (
          <svg
            className="w-4 h-4 text-gold-500/60 group-hover:text-gold-600 group-hover:translate-x-1 transition-all duration-300 ml-auto flex-shrink-0 relative z-10"
      ...
      <div className="mt-8 flex items-center justify-center gap-6">
        <div className="flex items-center gap-1.5 text-gray-500">
          ...
          <span className="font-sans text-[9px] uppercase tracking-wider font-semibold text-gray-600">Secured</span>
        </div>
        <div className="w-px h-3 bg-gold-300/40" />
        <div className="flex items-center gap-1.5 text-gray-500">
          <svg className="w-3.5 h-3.5 text-gold-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
          </svg>
          <span className="font-sans text-[9px] uppercase tracking-wider font-semibold text-gray-600">Private</span>
        </div>
        <div className="w-px h-3 bg-gold-300/40" />
        <div className="flex items-center gap-1.5 text-gray-500">
          <svg className="w-3.5 h-3.5 text-gold-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <span className="font-sans text-[9px] uppercase tracking-wider font-semibold text-gray-600">Instant</span>
        </div>
      </div>
      ...
      <p className="text-center font-sans text-[10px] text-gray-400 leading-relaxed mt-6 px-2">
        ...
        <span className="text-royal-blue-900 font-semibold cursor-pointer hover:text-gold-700 transition-colors underline">Terms of Service</span>
        {' '}&amp;{' '}
        <span className="text-royal-blue-900 font-semibold cursor-pointer hover:text-gold-700 transition-colors underline">Privacy Policy</span>.
      </p>
