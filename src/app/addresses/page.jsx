    ...
    <div className="w-full min-h-screen bg-sand-100 py-12 px-4 sm:px-6 lg:px-8 font-cormorant">
      <div className="max-w-[1100px] mx-auto space-y-8">
        ...
        <nav className="text-xs text-gray-500 font-semibold tracking-wide uppercase">
          ...
          <span className="text-royal-blue-900 font-bold">MY ADDRESSES</span>
        </nav>

        {/* Page Title */}
        <div className="text-center sm:text-left">
          <h1 className="font-cinzel text-3xl font-bold text-royal-blue-950 tracking-wider uppercase mb-1">Destinations</h1>
          <p className="text-gold-700 font-cinzel text-[10px] tracking-widest uppercase">Saved Addresses & Shipping Details</p>
          <div className="h-0.5 bg-gold-500/20 w-32 mt-3 mx-auto sm:mx-0" />
        </div>

        {/* AddressesList component details */}
